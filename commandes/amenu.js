...
const fetchGitHubStats = async () => {
  try {
    const _0x463b55 = await axios.get("https://api.github.com/repos/CybertechTz/Gmax-AI");
...
zokou({
  ...
  let _0xdb265e = "*☆ GMAX AI MD COMMANDS ☆*\n\n" + readmore;
  ...
  _0xdb265e += readmore + "\n☆ *ɢᴏᴅ ɪs ɢᴏᴏᴅ ᴀʟʟ ᴛɪᴍᴇ* ☆\n\n   *Released: 4.01.2025*\n   \n _Thanks For choosing GMAX AI-MD\n\n  Created by *Sir Gmax ©2O25* \n  \n     *KEEP USING GMAX AI-𝑴𝑫-𝑩𝑶𝑻*\n";
  try {
    await _0x339d30.sendMessage(_0x4517d6, {
      ...
      'contextInfo': {
        ...
        'externalAdReply': {
          'title': "𝐆𝐎𝐃 𝐈𝐒 𝐆𝐎𝐎𝐃 𝐀𝐋𝐋 𝐓𝐈𝐌𝐄",
          'body': "POWERED BY GMAX TECH",
