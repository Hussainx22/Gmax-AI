const {
  ...
  zokou({
    ...
    await _0x2c0d2b("*Pong ▱▱▰▰▰ :" + flashspeed + " MS* ");
  });
  zokou({
    'nomCom': "uptime",
    ...
    await _0x24712f("*_Uptime of GMAX AI-MD is: " + runtime(process.uptime()) + '_*');
  });
  zokou({
    'nomCom': 'ss',
    ...
    let _0x10a198 = "https://api.maher-zubair.adams/misc/sstab?url=" + _0x2afa0b + "&dimension=720x720";
