...
zokou({
  ...
  try {
    ...
    const _0x26eba0 = await axios.get("https://matrixcoder.tech/api/ai/photoleap?q=" + _0x4250f2);
...
zokou({
  ...
  try {
    ...
    const _0x5e0fc1 = await axios.get("https://matrixcoder.tech/api/ai/chatgpt4?q=" + _0x2fcbc4);
...
zokou({
  ...
  const _0x9ecab9 = await fetch("https://matrixcoder.tech/api/ai/mathssolve?q=" + cal);
